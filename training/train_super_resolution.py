...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Train RDN model for super-resolution",
    ...
    parser.add_argument(
        '--config', '-c',
        type=str,
        default='configs/super_resolution_config.yaml',
...
def train_super_resolution(config_path: str, data_path: str, val_data_path: str = None,
    ...
    if overrides.get('scale_factor'):
        config.model.scale_factor = overrides['scale_factor']
        print(f"Override: scale_factor = {config.model.scale_factor}")
    ...
    print(f"  Task: Super-Resolution ({config.model.scale_factor}x)")
...
def main():
    ...
    if args.create_config:
        ...
        print(f"Default super-resolution config created: {args.config}")
        return
    
    # Prepare overrides
    overrides = {}
    if args.scale_factor:
        overrides['scale_factor'] = args.scale_factor
    if args.epochs:
